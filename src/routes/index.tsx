...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      {
        title:
          "Ennieskitchen | Nigerian Food & Catering in Gardena, California",
      },
      {
        name: "description",
        content:
      ...
      },
      {
        property: "og:title",
        content:
          "Ennieskitchen | Nigerian Food & Catering in Gardena, CA",
      },
      {
...
const FEATURED = [
  {
    ...
    name: "Egusi Soup",
    alt: "Bowl of Nigerian egusi soup with assorted meat",
  },
  {
    img: "/images/efo-riro.jpg",
    name: "Efo Riro",
    alt: "Nigerian efo riro spinach stew with protein",
  },
  {
    img: "/images/moi-moi.jpg",
    name: "Moi Moi",
    alt: "Freshly steamed Nigerian moi moi bean pudding",
  },
  {
    img: "/images/boiled-rice.jpg",
    name: "Rice & Stew",
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 lg:grid-cols-2 lg:py-24">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg text-brand-brown/80">
              Freshly cooked jollof rice, rich soups, peppered protein and party
              trays for your family dinners and celebrations across Gardena and
              greater Los Angeles.
            </p>
            ...
            <p className="mt-5 text-sm font-semibold text-brand-brown/70">
              Pickup only · 24 hours notice on regular orders · 48–72 hours for
              catering
            </p>
          </div>
